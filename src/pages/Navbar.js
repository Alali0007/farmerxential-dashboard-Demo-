    ...
    <>
      <div style={{
        ...
        {!showLogoutConfirm ? (
          ...
          // Confirmation — two buttons appear
      ...
      {/* This appears below the navbar when any API call takes more than 3 seconds */}
      {/* Think of it like: a note sliding under the door saying "postman is on the way" */}
      {isSlowLoading && (
        <div style={{
